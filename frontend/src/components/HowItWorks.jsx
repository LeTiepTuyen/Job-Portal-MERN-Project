      ...
      {type === "recruiter" ? (
        <>
          <h1 className="md:text-6xl text-4xl font-bold text-center text-gray-900 ">
            How <strong>2THN Careers</strong> works for <strong>Recruiter</strong>
          </h1>
        ...
        <>
          <h1 className="md:text-6xl text-4xl font-bold text-center text-gray-900 ">
            How <strong>2THN Careers</strong> works for <strong>Applicants</strong>
          </h1>
        ...
        <>
          <h1 className="md:text-6xl text-4xl font-bold text-center text-gray-900 ">
            How <strong>2THN Careers</strong> works
          </h1>
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-12 md:py-32 py-12  text-center md:w-10/12 w-11/12  mx-auto ">
            <div>
              <FontAwesomeIcon
